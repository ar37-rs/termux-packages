...
_COMMIT_DATE=2025.03.08
_COMMIT=6c2737be88ac40f63a258c30e6a68d29feca0b1f
_COMMIT_POSISION=25008
...
termux_step_host_build() {
	...
	cp out/android/apks/AngleLibraries.apk build/vulkan/ && mkdir -p $TERMUX_PREFIX/opt/angle-android
